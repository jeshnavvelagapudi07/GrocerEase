      ...
      <div className="footer__container">
        <div className="footer__content">
          ...
          <div className="footer__section">
            <h3 className="footer__title">GrocerEase</h3>
            <p className="footer__description">
              Simplifying your shopping experience with fresh groceries delivered to your door.
            </p>
          </div>
          ...
          <div className="footer__section">
            ...
            <ul className="footer__links">
              ...
              <li><a href="#" className="footer__link">Delivery Info</a></li>
            </ul>
          </div>
        ...
        <div className="footer__bottom">
          <p className="footer__copyright">
            &copy; {currentYear} GrocerEase. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
